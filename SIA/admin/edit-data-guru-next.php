				...
				<div class="page-content">
					...
					<div class="row-fluid">
						<div class="span12">
							...
							<form class="form-horizontal" action="proses/update-kelas-guru.php" method="post" />
								...
								<div class="control-group">
								  ...
								  <div class="controls">
										<input readonly type="text" name="form-field-2" id="form-field-2" value="<?php echo $r['nama_lengkap']; ?>" />
								  </div>
								</div>
                                ...
                                <div class="control-group">
									...
									<label class="control-label" for="form-field-3">Mata Pelajaran</label>
                                  		<?php 
										...
										while($r=mysql_fetch_array($sql))
										{
										echo "<div class='controls'> <input readonly type='text' name='form-field-x' id='form-field-x' value='$r[nama_mapel]' />";
										echo "<input readonly type='text' name='form-field-3' id='form-field-3' value='$r[id]' style='display:none'  />";
										}
										?>
                                        </div> 

				...
				<div class="page-content">
					...
					<div class="row-fluid">
						<div class="span12">
							...
							<form name="visi" class="form-horizontal" action="proses/proses-input-guru.php" method="post" enctype="multipart/form-data" />
								                             
                                <div class="control-group">
                                	<label class="control-label" for="form-field-foto">Pilih Foto</label>
                                    <div class="controls"> 
                                    <img id="uploadPreview" style="width: 150px; height: 150px;" /><br>
                                    <input id="uploadImage" type="file" name="image" required onchange="PreviewImage();" />
                                    </div>
								</div>
                                
                                <!--<div class="control-group">
									<label class="control-label" for="form-field-foto" style="display:none"></label>

									<div class="controls">
										<input type="text" readonly name="form-field-foto" id="form-field-foto style="display:none""/>
                                        </div>
								</div>
                                -->
                                ...
                                <div class="control-group">
									...
									<div class="controls">
										<input type="text" name="form-field-1" id="form-field-1" placeholder="NIP" required />
									</div>
								</div>
								...
								<div class="control-group">
								  ...
								  <div class="controls">
										<input type="text" name="form-field-2" id="form-field-2" placeholder="Nama Lengkap" />
								  </div>
								</div>
                                ...
                                <div class="control-group">
								  ...
								  <div class="controls">
										<input type="text" name="form-field-3" id="form-field-3" placeholder="NRK" />
								  </div>
								</div>
                                ...
                                <div class="control-group">
								  ...
								  <div class="controls">
										<input type="text" name="form-field-4" id="form-field-4" placeholder="Tempat Lahir" />
								  </div>
								</div>
                                ...
                                <div class="control-group">
                                  ...
                                  <div class="controls">
										<p>
										  <input data-rel="tooltip" type="date" name="form-field-5" id="form-field-5" placeholder="Tanggal Bulan Tahun" title="tahun-bulan-tanggal" data-placement="bottom" />
                                ...
                                <div class="control-group">
								  ...
								  <div class="controls">
                                  	<textarea  limited" name="form-field-6" id="form-field-6"></textarea>
                                ...
                                <div class="control-group">
									...
									<div class="controls">
										<span class="input-icon">
											<input type="number" name="form-field-7" id="form-field-7" />
                                 ...
                                 <div class="control-group">
                                    ...
                                    <div class="controls">
										<span class="input-icon">
											<input type="email" name="form-field-8" id="form-field-8" />

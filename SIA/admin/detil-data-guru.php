				...
				<div class="page-content">
					<div class="row-fluid">
						...
						<div class="span12">
                                            ...
                                            <div class="profile-info-row">
												...
												<div class="profile-info-value">
													<span><?php 
															...
															$sql=mysql_query("SELECT * from tbl_user WHERE username='$_GET[id]' ");
															while($xy=mysql_fetch_array($sql))
															{
																echo $xy['password']; 
															}
															?></span>
							...
							<a href="data-guru.php" <div class="span-12"> <button class="btn btn-info" type="button">

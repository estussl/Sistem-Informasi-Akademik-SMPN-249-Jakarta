				...
				<div class="page-content">
					...
					<div class="row-fluid">
						<div class="span12">
							...
							<form class="form-horizontal" action="proses/update-data-siswa.php" method="post" />
                                ...
                                <div class="control-group">
								  ...
								  <div class="controls">
                                  	<textarea  limited" name="form-field-5" id="form-field-5"><?php echo $r['alamat']; ?></textarea>
                                ...
                                <div class="control-group">
                                    ...
                                    <div class="controls">
										<input type="text" name="form-field-6" id="form-field-6" value="<?php echo $r['nama_ayah']; ?>" />
									</div>
								</div>
                                ...
                                <div class="control-group">
                                    ...
                                    <div class="controls">
										<input type="text" name="form-field-7" id="form-field-7" value="<?php echo $r['nama_ibu']; ?>" />
									</div>
								</div>
                                ...
                                <div class="control-group">
									...
									<div class="controls">
										<span class="input-icon">
											<input type="number" name="form-field-8" id="form-field-8"  value="<?php echo $r['tlpn']; ?>"/>
                                 ...
                                 <div class="control-group">
                                    ...
                                    <div class="controls">
										<span class="input-icon">
											<input type="email" name="form-field-9" id="form-field-9" value="<?php echo $r['email']; ?>" />
									...
									<label class="control-label" for="form-field-10">Kelas</label>
                                         ...
                                         <div class="controls">
														...
														<select name="form-field-10" id="form-field-10">
															<option value="<?php echo $r['kelas']; ?>" /><?php echo $r['kelas']; ?>
															<?php 

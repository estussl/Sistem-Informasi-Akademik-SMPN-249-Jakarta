				...
				<div class="page-content">
					...
					<div class="row-fluid">
						<div class="span12">
							...
							<form class="form-horizontal" action="daftar-nilai-next.php" method="post" />
                                ...
                                <div class="controls">
														...
														<select required name="form-field-2" id="form-field-2">
															<?php 
															$r1 = mysql_fetch_array(mysql_query("SELECT * FROM tbl_siswa WHERE NISN='$_SESSION[username]'"));
															$sql=mysql_query("SELECT * from tbl_kelas WHERE id='$r1[kelas]'");

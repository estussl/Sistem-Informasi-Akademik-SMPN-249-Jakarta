				...
				<div class="page-content">
					...
					<div class="row-fluid">
						<div class="span12">
							...
							<?php
							$sql=mysql_query("select * from tbl_guru where NIP='$_SESSION[username]'") or die(mysql_error());
							...
							<form class="form-horizontal"  action="proses/update-profil.php" method="post" enctype="multipart/form-data"  />
                                ...
                                <div class="control-group">
                                	<div class="controls">
                               		<a href="edit-profil-next.php?id=<?php echo $idnya?>" class="btn btn-small btn-primary">
									<i class="icon-edit"></i>
                                    Edit kelas yang diajar
									</a>
                                	</div>
                                </div>
